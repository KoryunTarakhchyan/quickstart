...
/*------------------------------------------------------------------------------------*\
+--------------------------------------------------------------------------------------+
| Created by Hussein Sabbagh of Sabbagh Media Group                                    |
+--------------------------------------------------------------------------------------+
| THIS CODE WAS CREATED BY SABBAGH MEDIA GROUP AND IS PROTECTED BY LAW. NO UNLAWFUL    |
| REDISTRIBUTION IS PERMITTED. LEGAL ACTION WILL BE TAKEN AGAINST OFFENDERS. IF YOU    |
| HAVE COME ABOUT THIS WITHOUT KNOWLEDGE THE CONTRACT PLEASE INFORM SABBAGH MEDIA      |
| GROUP AND YOU MAY BE REWARDED A PERCENTAGE OF ALL COURT EARNINGS.                    |
+--------------------------------------------------------------------------------------+
| CONTACT: hsabbagh@s-mediagroup.com                                                   |
+--------------------------------------------------------------------------------------+
| Copyright 2012 Sabbagh Media Group, www.s-mediagroup.com                             |
+--------------------------------------------------------------------------------------+
\*------------------------------------------------------------------------------------*/

// this module will serve as a paginator for Zend_Select queries
// it will parse the query to determine the number of pages and
// return the required results for display of pagination panel as
// well as holding the variables. this form of pagination will return
// the results at initialization and seperate it from the overall structure
// allowing for easy cache handling
...
class Utility_MsSQLPaginator
{
	...
	private function buildQueries()
	{
        ...
        $select_clause = substr($this->_original_query, $select_start, $from_start);
