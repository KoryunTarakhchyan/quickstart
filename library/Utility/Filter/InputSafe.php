...
class Utility_Filter_InputSafe implements Zend_Filter_Interface
{
	...
	public static function makeInputSafe($value)
	{
		$value = trim($value);
	...
	public function filter($value)
	{
		if( is_array($value) ){
			...
			return $this->makeInputSafe($value);
		}
	...
	public static function clean($value)
	{
		if( is_array($value) ){
			...
			return self::makeInputSafe($value);
		}
