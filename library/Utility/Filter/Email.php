...
class Utility_Email
{
	...
	public function __construct()
	{
		...
		$this->_domain = "jarrow.com";
		$this->_mail   = new phpmailer();
		$this->_mail->isSMTP();

		$this->_mail->Host     = "192.168.2.33";
		$this->_mail->Username = 'no-reply@jarrow.com';
		$this->_mail->Password = 'Matrix1824';
		
		$this->_mail->From     = "no-reply@jarrow.com";
		$this->_mail->FromName = "Jarrow Formulas, Inc.";
		$this->_mail->Sender   = "no-reply@jarrow.com";

		$this->_mail->WordWrap = 900;
