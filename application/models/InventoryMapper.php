...
class Atlas_Model_InventoryMapper
{
        protected $_dbTable;
    ...
    public function getDbTable() {
        if (null === $this->_dbTable) {
            $this->setDbTable('Atlas_Model_DbTable_Inventory');
        }
        return $this->_dbTable;
    }
 
    public function save(Atlas_Model_Inventory $item){
    ...
    public function find($id) {
        $item = new Atlas_Model_Inventory(); 
    ...
    public function fetchAll() {
        ...
        foreach ($resultSet as $row) {
            $entry = new Atlas_Model_Inventory();
    ...
    public function buildAllInventoryItems() {
        $select = $this->getDbTable()->select();
        $select->setIntegrityCheck(false)
                ->from(array("ak" => "inventory"), array("ak.*"));
